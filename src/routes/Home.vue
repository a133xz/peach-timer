<template>
  <nav class="nav">
    <div class="flex nav-wrapper">
      <div class="flex">
        <a :class="{ 'selected': selectedTab }" @click="selectedTab = true">Timer</a>
        <a :class="{ 'selected': !selectedTab }" @click="selectedTab = false">Stats</a>
      </div>
      <div class="icons">
        ...
        <!-- <svg style="margin-left: 5px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
          <path
