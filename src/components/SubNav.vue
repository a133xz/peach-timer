<template>
    <nav class="nav">
        <div class="flex nav-wrapper">
            <div class="flex">
                <a :class="{ 'selected': selectedTab }" @click="setSelectedTab(true)">Timer</a>
                <a :class="{ 'selected': !selectedTab }" @click="setSelectedTab(false)">Stats</a>
            </div>
            <div class="icons">
                <!-- <svg @click="clickToSave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="20" height="20">
          <path
